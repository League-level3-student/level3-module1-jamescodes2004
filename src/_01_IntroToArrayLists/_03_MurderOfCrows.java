    ...
    private void findTheDiamond() {
        ...
        for (int i = 0; i < theMurder.size(); i++) {
			if(theMurder.get(i).getStomachContents().contains("diamond")) {
				System.out.println(theMurder.get(i).getName()+" had the diamonds!" );
				break;
			}
			else {
				System.out.println(theMurder.get(i).getName()+" had " + theMurder.get(i).getStomachContents() + ", he was killed unecessarily");
			crowsKilled= crowsKilled+1;
			}
		}
        /* 2. How many innocent crows had to die before the diamond was found? */
    	System.out.println("There were " + crowsKilled + " unecessary crow deaths");
    }
